...
public class ModBlocks {
    ...
    public static final Block ANTHRACITE_RIVETED_HULL_SMALL_STAIRS = registerBlock("anthracite_riveted_hull_small_stairs",
            new StairsBlock(ModBlocks.ANTHRACITE_RIVETED_HULL_SMALL.getDefaultState(),AbstractBlock.Settings.copy(WatheBlocks.DARK_STEEL)));
    ...
    public static final Block BLACK_RIVETED_HULL_SMALL_STAIRS = registerBlock("black_riveted_hull_small_stairs",
            new StairsBlock(ModBlocks.BLACK_RIVETED_HULL_SMALL.getDefaultState(),AbstractBlock.Settings.copy(WatheBlocks.DARK_STEEL)));
    ...
    public static final Block MAROON_RIVETED_HULL_SMALL_STAIRS = registerBlock("maroon_riveted_hull_small_stairs",
            new StairsBlock(ModBlocks.MAROON_RIVETED_HULL_SMALL.getDefaultState(),AbstractBlock.Settings.copy(WatheBlocks.DARK_STEEL)));
    ...
    public static final Block MUNTZ_RIVETED_HULL_SMALL_STAIRS = registerBlock("muntz_riveted_hull_small_stairs",
            new StairsBlock(ModBlocks.MUNTZ_RIVETED_HULL_SMALL.getDefaultState(),AbstractBlock.Settings.copy(WatheBlocks.DARK_STEEL)));
    ...
    public static final Block NAVY_RIVETED_HULL_SMALL_STAIRS = registerBlock("navy_riveted_hull_small_stairs",
            new StairsBlock(ModBlocks.NAVY_RIVETED_HULL_SMALL.getDefaultState(),AbstractBlock.Settings.copy(WatheBlocks.DARK_STEEL)));
    ...
    public static final Block WHITE_RIVETED_HULL_SMALL_STAIRS = registerBlock("white_riveted_hull_small_stairs",
            new StairsBlock(ModBlocks.WHITE_RIVETED_HULL_SMALL.getDefaultState(),AbstractBlock.Settings.copy(WatheBlocks.DARK_STEEL)));
    ...
    public static final Block ANTHRACITE_RIVETED_HULL = registerBlock("anthracite_riveted_hull",
            new DoubleHullBlock(AbstractBlock.Settings.copy(WatheBlocks.DARK_STEEL)));
    ...
    public static final Block CORRUGATED_DARK_STEEL_STAIRS = registerBlock("corrugated_dark_steel_stairs",
            new StairsBlock(ModBlocks.CORRUGATED_DARK_STEEL.getDefaultState(),AbstractBlock.Settings.copy(WatheBlocks.DARK_STEEL)));
    ...
    public static final Block CORRUGATED_STAINLESS_STEEL_STAIRS = registerBlock("corrugated_stainless_steel_stairs",
            new StairsBlock(ModBlocks.CORRUGATED_STAINLESS_STEEL.getDefaultState(),AbstractBlock.Settings.copy(WatheBlocks.DARK_STEEL)));
    ...
    public static final Block PERFORATED_STAINLESS_STEEL_STAIRS = registerBlock("perforated_stainless_steel_stairs",
            new StairsBlock(ModBlocks.PERFORATED_STAINLESS_STEEL.getDefaultState(),AbstractBlock.Settings.copy(WatheBlocks.DARK_STEEL)));
    ...
    public static final Block PERFORATED_DARK_STEEL_STAIRS = registerBlock("perforated_dark_steel_stairs",
            new StairsBlock(ModBlocks.PERFORATED_DARK_STEEL.getDefaultState(),AbstractBlock.Settings.copy(WatheBlocks.DARK_STEEL)));
    ...
    public static final Block BUTTERFLY_DOOR_BLOCK = registerBlock("butterfly_door",
            new ButterflyDoorBlock(AbstractBlock.Settings.copy(WatheBlocks.DARK_STEEL).nonOpaque()));

    public static final Block KILL_BLOCK_PANEL = registerBlock("kill_block_panel",
            new KillBlockPanel(AbstractBlock.Settings.copy(WatheBlocks.BARRIER_PANEL)));
    ...
    public static final Block SERVICE_BELL = registerBlock("service_bell",
            new SmallBellBlock(ModSounds.SERVICE_BELL,AbstractBlock.Settings.copy(WatheBlocks.DARK_STEEL).nonOpaque()));
    ...
    private static Block registerBlock(String name, Block block){
        ...
        return Registry.register(Registries.BLOCK, Identifier.of(WathExtras.MOD_ID,name),block);
    }

    private static void registerBlockItem(String name, Block block){
        Registry.register(Registries.ITEM, Identifier.of(WathExtras.MOD_ID,name),
                new BlockItem(block, new Item.Settings()));
    }

    // Creative Item Group Striped Carpets
    public static final RegistryKey<ItemGroup> STRIPED_CARPET_KEY = RegistryKey.of(Registries.ITEM_GROUP.getKey(), Identifier.of(WathExtras.MOD_ID, "striped_carpet_group"));
    ...
    public static final RegistryKey<ItemGroup> MOQUETTES_KEY = RegistryKey.of(Registries.ITEM_GROUP.getKey(), Identifier.of(WathExtras.MOD_ID, "moquette_group"));
    ...
    public static final RegistryKey<ItemGroup> TMMORE_BUILDING_KEY = RegistryKey.of(Registries.ITEM_GROUP.getKey(), Identifier.of(WathExtras.MOD_ID, "tmmore_building_group"));
