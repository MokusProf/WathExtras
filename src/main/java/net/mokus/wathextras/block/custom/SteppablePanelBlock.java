...
public class SteppablePanelBlock extends PanelBlock {
    ...
    private static final VoxelShape SOUTH_SHAPE = createCuboidShape(0.0, 0.0, 0.0, 16.0, 8, 0.1);
    private static final VoxelShape NORTH_SHAPE = createCuboidShape(0.0, 0.0, 15.9, 16.0, 8, 16.0);
    ...
    public SteppablePanelBlock(Settings settings) {
        super(settings);
        this.SHAPES = this.getShapesForStates(SteppablePanelBlock::getShapeForState);
    }
